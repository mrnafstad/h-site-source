  ...
  <div>
    <div v-if="auth">
      ...
      <div v-if="!user.displayName">
        Your username is not set:
        <p>
          <input v-model="username" placeholder="Update not available at the moment" />
          <button id="setname" @click="setUsername">Set username</button>
        </p>
      </div>
    ...
    <div v-if="!auth">You need to sign in and if you're not me, you have to find a hack for this</div>
  </div>
</template>
